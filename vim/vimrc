...
nnoremap <leader>f :<C-u>Unite -no-split -buffer-name=files buffer file_rec/async:!<cr>
nnoremap <leader>h :<C-u>UniteWithBufferDir -no-split -buffer-name=files buffer file_rec/async:!<cr>
...
if executable('ack-grep')
    ...
    nnoremap <leader>F :<C-u>Unite -no-split -buffer-name=files grep<cr>
endif

autocmd FileType unite call s:unite_settings()
autocmd! BufEnter Unite,*files,*yank,*buffer hi ExtraWhitespace none
